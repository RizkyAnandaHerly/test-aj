<x-app-layout>
    <x-slot name="header">Master Vendor</x-slot>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-2 px-4 d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="fw-bold mb-0 text-dark">Tambah Vendor Baru</h5>
                        <p class="text-muted small mb-0">Daftarkan vendor/supplier baru ke dalam sistem</p>
                    </div>
                </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-8 mb-3 mb-md-0">
                                ...
                                <input type="text" name="name" id="name"
                                       ...
                                       placeholder="Contoh: PT Petani Kopi Gayo"
