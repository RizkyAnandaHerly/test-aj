        ...
        <form action="{{ route('sales-orders.update', $salesOrder->id) }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('origin_country') is-invalid @enderror" id="origin_country" name="origin_country" value="{{ old('origin_country', $salesOrder->origin_country) }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('destination_country') is-invalid @enderror" id="destination_country" name="destination_country" value="{{ old('destination_country', $salesOrder->destination_country) }}" required>
