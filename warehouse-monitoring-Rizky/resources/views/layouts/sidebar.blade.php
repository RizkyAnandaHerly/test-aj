...
<head>
    ...
    <title>@yield('title', 'WarehouseTrack') — WarehouseTrack</title>
...
<aside id="sidebar">
    ...
    {{-- Brand --}}
    <a href="{{ auth()->user()?->hasRole('admin') ? route('admin.dashboard')
    ...
    <nav class="sidebar-nav">
        ...
        @elseif(Auth::user()->hasRole('manager'))
            ...
            <a href="{{ route('manager.dashboard') }}"
               class="sidebar-item {{ request()->routeIs('manager.dashboard') ? 'active' : '' }}">
                <i class="bi bi-speedometer2 nav-icon"></i> Dashboard
            </a>
        ...
        @elseif(Auth::user()->hasRole('staff'))
            ...
            <a href="{{ route('staff.dashboard') }}"
               class="sidebar-item {{ request()->routeIs('staff.dashboard') ? 'active' : '' }}">
                <i class="bi bi-speedometer2 nav-icon"></i> Dashboard
            </a>
...
<div id="main-wrapper">
    ...
    <header id="top-header">
        ...
        <div class="header-user-info">
            @php $role = Auth::user()->role?->name ?? 'user'; @endphp
            <div class="header-user-name d-none d-sm-block">{{ Auth::user()->name }}</div>
            <span class="header-role-badge role-{{ $role }}">{{ ucfirst($role) }}</span>
