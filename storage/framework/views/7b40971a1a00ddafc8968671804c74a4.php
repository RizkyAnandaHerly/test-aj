...
<div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
    <div>
        ...
        <p class="text-muted mb-0 small">
            <?php echo e(now()->translatedFormat('l, d F Y')); ?> — Hari ini adalah hari yang produktif!
        </p>
    </div>
...
<div class="row g-3 mb-4">
        ...
        <div class="card border-0 shadow-sm h-100 rounded-3">
            <div class="card-body p-3">
                ...
                <div class="fw-semibold" style="font-size:0.75rem;color:#3b82f6;margin-top:2px;">
                    <?php echo e(number_format($todayQty)); ?> unit masuk
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100 rounded-3
                    <?php echo e($pendingQC > 0 ? 'border-warning border' : ''); ?>">
            <div class="card-body p-3">
                <div class="d-flex align-items-start justify-content-between mb-2">
                    <div class="rounded-2 d-flex align-items-center justify-content-center"
    ...
    <div class="col-6 col-lg-3">
        <div class="card border-0 shadow-sm h-100 rounded-3
                    <?php echo e($lowStock > 0 ? 'border-danger border' : ''); ?>">
            <div class="card-body p-3">
                <div class="d-flex align-items-start justify-content-between mb-2">
                    <div class="rounded-2 d-flex align-items-center justify-content-center"
    ...
    <div class="card-body px-4 pb-4 pt-0">
        <div class="row g-3">
            ...
            <div class="col-12 col-md-4">
                <a href="<?php echo e(route('inbounds.create')); ?>"
...
<div class="row g-3 mb-4">
    ...
    <div class="col-12 col-lg-6">
        <div class="card border-0 shadow-sm rounded-3 h-100">
            ...
            <div class="card-body p-0">
                <?php if($recentInbounds->isNotEmpty()): ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 small">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentInbounds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inbound): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="ps-4 py-2">
                                            <div class="fw-semibold text-dark" style="font-size:.8rem;">
                                                <?php echo e(Str::limit($inbound->product?->name ?? '—', 22)); ?>

                                            </div>
                                            <div class="text-muted" style="font-size:.7rem;">
                                                <?php echo e($inbound->product?->sku); ?>

                                            </div>
                                        </td>
                                        <td class="py-2 text-center">
                                            <span class="fw-bold" style="color:#2563eb;"><?php echo e(number_format($inbound->qty)); ?></span>
                                        </td>
                                        <td class="py-2 text-muted" style="font-size:.78rem;">
                                            <?php echo e($inbound->vendor?->name ?? '—'); ?>
            ...
            <div class="card-footer bg-white border-top px-4 py-2">
                <a href="<?php echo e(route('inbounds.create')); ?>" class="small text-primary fw-semibold text-decoration-none">
    ...
    <div class="col-12 col-lg-6">
        <div class="card border-0 shadow-sm rounded-3 h-100">
                ...
                <?php if($recentQC->isNotEmpty()): ?>
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0 small">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $recentQC; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $qc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="ps-4 py-2">
                                            <div class="fw-semibold text-dark" style="font-size:.8rem;">
                                                <?php echo e(Str::limit($qc->product?->name ?? '—', 22)); ?>

                                            </div>
                                        </td>
                                        <td class="py-2 text-muted" style="font-size:.78rem;">
                                            <?php echo e($qc->inspector?->name ?? '—'); ?>
                                        ...
                                        <td class="pe-4 py-2 text-muted" style="font-size:.75rem;">
                                            <?php echo e($qc->inspection_date?->format('d/m/Y') ?? '—'); ?>
            ...
            <div class="card-footer bg-white border-top px-4 py-2">
                <a href="<?php echo e(route('qc-inspections.index')); ?>" class="small text-success fw-semibold text-decoration-none">
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rakea\Documents\GitHub\test-aj\resources\views/staff/dashboard.blade.php ENDPATH**/ ?>