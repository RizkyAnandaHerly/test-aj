                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group custom-input-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control border-start-0 ps-0 py-2" placeholder="nama@email.com" value="<?php echo e(old('email')); ?>" required autofocus>
                        </div>
...
</html><?php /**PATH C:\Users\rakea\Documents\GitHub\test-aj\resources\views/auth/login.blade.php ENDPATH**/ ?>