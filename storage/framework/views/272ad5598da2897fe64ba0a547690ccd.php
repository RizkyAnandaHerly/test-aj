...
<body>
  ...
  <nav id="navbar">
    ...
    <div class="nav-links">
      ...
      <a href="<?php echo e(route('track')); ?>">Lacak Order</a>
      <a href="<?php echo e(route('login')); ?>" class="nav-btn">Masuk Sistem</a>
    </div>
  </nav>
  ...
  <section id="cta">
    ...
    <div id="cta-content">
      ...
      <a href="<?php echo e(route('login')); ?>" class="btn-white">Masuk ke Sistem Utama</a>
    </div>
  </section>
  ...
  <script>
    ...
    function goToTrack() {
      ...
      if (input) {
        window.location.href = "<?php echo e(route('track')); ?>?order_id=" + encodeURIComponent(input);
      } else {
        window.location.href = "<?php echo e(route('track')); ?>";
      }
    }
...
<?php /**PATH C:\Users\rakea\Documents\GitHub\test-aj\resources\views/landing.blade.php ENDPATH**/ ?>